...
let cacheKeySection = 'SectionModule';
let sessionId = `Sections_${scopeTokenData.id}`;
let apiModuleLibrary = "Library";
let apiModuleRoom = "Room";
let apiModuleSection = "Section";
let libId = '';
let roomId = '';
let sectionId = '';
let apiUrlToGetAllLibrary = `https://localhost/ApiGateway/${apiModuleLibrary}/getall`;
let apiUrlToGetAllRoom = `https://localhost/ApiGateway/${apiModuleRoom}/getall?libraryId=${libId}`;
let apiUrlToGetAllSection = `https://localhost/ApiGateway/${apiModuleSection}/getall?roomid=${roomId}`;
let apiUrlToSectionGetById = `https://localhost/ApiGateway/${apiModuleRoom}/get?roomId=${roomId}&sectionid=${sectionId}`;

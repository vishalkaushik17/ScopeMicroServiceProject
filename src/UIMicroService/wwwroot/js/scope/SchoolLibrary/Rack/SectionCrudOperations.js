...
async function refreshSectionIndexWithoutCache() {
...
async function FetchLibraryRecords(obj, selectListObject) {
...
async function FetchRoomRecords(obj, selectListObject) {
...
async function FetchSectionRecords(roomId,libraryId, obj) {
...
async function fillDataInLibrarySelectList(data, selectElement,firstValue) {
...
//============== new imp
async function fillSectionTable(data) {
...
async function addRowToIndex(cacheData, ajaxData, id, obj) {
...
async function loadLibraryAndRoomOnModel(libraryId, roomId) {
...
async function loadSectionRecordForEdit(id, roomId, libraryId) {

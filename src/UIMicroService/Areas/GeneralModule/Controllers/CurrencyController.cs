...
namespace ScopeCoreWebApp.Areas.GeneralModule.Controllers
{
    ...
    public class CurrencyController : BaseAppController
    {
        public CurrencyController(IWebHostEnvironment hostingEnvironment, ITrace trace, IHttpContextAccessor httpContextAccessors,
        ...
        public async Task<SPAResponse<string>> Index()
        {
            try
            {
                BaseVMTemplate model = new CurrencyVm();

...
namespace ScopeCoreWebApp.Areas.EmployeeModule.Controllers
{
    ...
    public class DesignationController : BaseAppController
    {
        public DesignationController(IWebHostEnvironment hostingEnvironment, ITrace trace, IHttpContextAccessor httpContextAccessors,
        ...
        public async Task<SPAResponse<string>> Index()
        {
            try
            {
                BaseVMTemplate model = new DesignationsVM();
                model.Id = "";

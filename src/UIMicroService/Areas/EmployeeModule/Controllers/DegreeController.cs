...
namespace ScopeCoreWebApp.Areas.EmployeeModule.Controllers
{
    ...
    public class DegreeController : BaseAppController
    {
        public DegreeController(IWebHostEnvironment hostingEnvironment, ITrace trace, IHttpContextAccessor httpContextAccessors,
        ...
        public async Task<SPAResponse<string>> Index()
        {
            try
            {
                BaseVMTemplate model = new DegreeVM();
                model.Id = "";

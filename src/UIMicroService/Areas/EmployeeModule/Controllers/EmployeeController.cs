...
namespace ScopeCoreWebApp.Areas.EmployeeModule.Controllers
{
    ...
    {
        public EmployeeController(IWebHostEnvironment hostingEnvironment, ITrace trace, IHttpContextAccessor httpContextAccessors,
        ...
        public async Task<SPAResponse<string>> Index()
        {
            try
            {
                BaseVMTemplate model = new EmployeeVm();
                model.Id = "";

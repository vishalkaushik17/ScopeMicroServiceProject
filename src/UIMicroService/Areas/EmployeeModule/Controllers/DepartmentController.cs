...
namespace ScopeCoreWebApp.Areas.EmployeeModule.Controllers
{
    ...
    public class DepartmentController : BaseAppController
    {
        public DepartmentController(IWebHostEnvironment hostingEnvironment, ITrace trace, IHttpContextAccessor httpContextAccessors,
        ...
        public async Task<SPAResponse<string>> Index()
        {
            try
            {
                BaseVMTemplate model = new DepartmentVM();
                model.Id = "";

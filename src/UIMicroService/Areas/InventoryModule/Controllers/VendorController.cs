...
namespace ScopeCoreWebApp.Areas.InventoryModule.Controllers
{
    ...
    public class VendorController : BaseAppController
    {
        public VendorController(IWebHostEnvironment hostingEnvironment, ITrace trace, IHttpContextAccessor httpContextAccessors,
        ...
        public async Task<SPAResponse<string>> Index()
        {
            try
            {
                BaseVMTemplate model = new VendorMasterVm();

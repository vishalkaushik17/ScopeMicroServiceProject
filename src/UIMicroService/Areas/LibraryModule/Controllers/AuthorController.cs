...
{
    [Area(nameof(LibraryModule))]
    public class AuthorController : BaseAppController
    {
        public AuthorController(IWebHostEnvironment hostingEnvironment, ITrace trace, IHttpContextAccessor httpContextAccessors,

...
const objModuleName: _type.ModuleSpecificObjectType = {
    ...
    CacheKey: "Currency", //for browser cache
    ApiModule: 'Currency', //this is api route name
    ApiType:_type.ApiType.Json,
    UseBrowserCache: true,
    UseRedisCache: true,
    BaseUrl: `https://localhost/ApiGateway`,
    RecordId: ``,
    AsideBarLink: `Currency-GeneralModule`, //aside bar link class
    AsideBarModuleId: `GeneralLi`, //aside bar link id to dispaly active
    IndexTitle: `Currencies`, //title of the page
...
export class clsIndexPage {
    ...
    public static async FillDataOnIndexTable(result: object[] | any[]) {
        ...
        result.forEach((record) => {
            ...
            templateRow += `<p class="text-blue">Currency symbol :&nbsp;<span class="text-black">${record.symbol}</span></p>`;

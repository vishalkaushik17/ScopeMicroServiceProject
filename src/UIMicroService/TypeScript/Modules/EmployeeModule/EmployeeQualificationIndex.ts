...
const objModuleName: _type.ModuleSpecificObjectType = {
    ...
    ApiModule: 'EmployeeQualification',
    ...
    IndexTitle: `Employee's Qualifications`,
...
export class clsIndexPage {
    ...
    public static async FillDataOnIndexTable(result: object[] | any[]) {
        ...
        result.forEach((record) => {
            ...
            templateRow += `<span><strong> Name:</strong> ${record.firstName} ${record.middleName} ${record.lastName} &nbsp;</span>`;

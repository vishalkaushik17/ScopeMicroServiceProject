...
//    (string Subject, string Body) GenerateDemoRequestBody(ResponseDto<DemoRequestDtoModel> responseDto, string? id, bool generate);
...
//    (string subject, string body) CreateNewUserEmailBody(ResponseDto<ApplicationUser> responseDto,
//         CompanyMasterModel company, string confirmationLink);
//}
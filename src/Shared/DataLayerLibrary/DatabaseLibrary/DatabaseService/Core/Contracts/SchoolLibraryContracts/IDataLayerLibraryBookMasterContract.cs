...
namespace DataBaseServices.Core.Contracts.SchoolLibraryContracts
{
    ...
    /// </summary>
    public interface IDataLayerLibraryBookMasterContract
    {
        ...
        /// <returns></returns>
        Task<LibraryBookMasterModel?> GetAsync(string id);

        /// <summary>
        /// Get all records.
        /// </summary>
        /// <returns>Get list of records.</returns>
        Task<List<LibraryBookMasterModel>?> GetAllAsync();
        ...
        Task<LibraryBookMasterModel> AddAsync(LibraryBookMasterModel modelRecord);
        ...
        Task<LibraryBookMasterModel> UpdateAsync(LibraryBookMasterModel modelRecord);

...
namespace DataBaseServices.Core.Contracts.SchoolLibraryContracts
{
    ...
    /// </summary>
    public interface IDataLayerSchoolLibraryHallContract
    {
        ...
        /// <returns></returns>
        Task<SchoolLibraryHallModel?> GetAsync(string id);

        /// <summary>
        /// Get all records.
        /// </summary>
        /// <returns>Get list of records.</returns>
        Task<List<SchoolLibraryHallModel>?> GetAllAsync();
        ...
        Task<SchoolLibraryHallModel> AddAsync(SchoolLibraryHallModel modelRecord);
        ...
        Task<SchoolLibraryHallModel> UpdateAsync(SchoolLibraryHallModel modelRecord);

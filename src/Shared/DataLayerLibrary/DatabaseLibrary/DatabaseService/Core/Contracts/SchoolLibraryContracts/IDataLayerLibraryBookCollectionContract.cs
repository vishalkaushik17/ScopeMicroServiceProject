...
/// </summary>
public interface IDataLayerLibraryBookCollectionContract
{
    ...
    /// <returns></returns>
    Task<LibraryBookCollectionModel?> GetAsync(string id);

    /// <summary>
    /// Get all records.
    /// </summary>
    /// <returns>Get list of records.</returns>
    Task<List<LibraryBookCollectionModel>?> GetAllAsync();
    ...
    Task<LibraryBookCollectionModel> AddAsync(LibraryBookCollectionModel modelRecord);
    ...
    Task<LibraryBookCollectionModel> UpdateAsync(LibraryBookCollectionModel modelRecord);

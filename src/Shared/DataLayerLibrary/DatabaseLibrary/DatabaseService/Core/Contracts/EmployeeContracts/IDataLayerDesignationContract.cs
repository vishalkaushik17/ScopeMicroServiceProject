...
/// </summary>
public interface IDataLayerDesignationContract// : IGenericContract<VendorModel>
{
    /// <summary>
    ...
    /// <returns></returns>
    Task<DesignationModel?> GetAsync(string id);
    ...
    Task<DesignationModel> AddAsync(DesignationModel modelRecord);
    ...
    Task<DesignationModel> UpdateAsync(DesignationModel modelRecord);

    /// <summary>
    /// Delete record from database.
    /// </summary>
    /// <returns>return true if record deleted.</returns>
    Task<DesignationModel> DeleteAsync(DesignationModel modelRecord);

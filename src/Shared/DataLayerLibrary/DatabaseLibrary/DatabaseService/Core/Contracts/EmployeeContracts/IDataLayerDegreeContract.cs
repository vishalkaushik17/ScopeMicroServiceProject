...
/// </summary>
public interface IDataLayerDegreeContract// : IGenericContract<VendorModel>
{
    /// <summary>
    ...
    /// <returns></returns>
    Task<DegreeModel?> GetAsync(string id);

    /// <summary>
    /// Get all records.
    /// </summary>
    /// <returns>Get list of records.</returns>
    Task<List<DegreeModel>?> GetAllAsync();
    ...
    Task<DegreeModel> AddAsync(DegreeModel modelRecord);
    ...
    Task<DegreeModel> UpdateAsync(DegreeModel modelRecord);

    /// <summary>
    /// Delete record from database.
    /// </summary>
    /// <returns>return true if record deleted.</returns>
    Task<DegreeModel> DeleteAsync(DegreeModel modelRecord);

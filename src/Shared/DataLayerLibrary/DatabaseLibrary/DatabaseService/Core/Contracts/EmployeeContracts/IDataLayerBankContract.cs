...
/// </summary>
public interface IDataLayerBankContract
{
    /// <summary>
    ...
    /// <returns></returns>
    Task<BankModel?> GetAsync(string id);

    /// <summary>
    /// Get all records.
    /// </summary>
    /// <returns>Get list of records.</returns>
    Task<List<BankModel>?> GetAllAsync();
    ...
    Task<BankModel> AddAsync(BankModel modelRecord);
    ...
    Task<BankModel> UpdateAsync(BankModel modelRecord);

    /// <summary>
    /// Delete record from database.
    /// </summary>
    /// <returns>return true if record deleted.</returns>
    Task<BankModel> DeleteAsync(BankModel modelRecord);

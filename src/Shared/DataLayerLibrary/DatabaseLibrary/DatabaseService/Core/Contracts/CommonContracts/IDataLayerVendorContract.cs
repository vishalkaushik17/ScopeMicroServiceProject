...
/// For Managing Vendor
/// </summary>
public interface IDataLayerVendorContract
{
    ...
    /// <returns></returns>
    Task<VendorModel?> GetAsync(string id);
    ...
    Task<VendorModel> AddAsync(VendorModel modelRecord);
    ...
    Task<VendorModel> UpdateAsync(VendorModel modelRecord);

    /// <summary>
    /// Delete record from database.
    /// </summary>
    /// <returns>return true if record deleted.</returns>
    Task<VendorModel> DeleteAsync(VendorModel modelRecord);

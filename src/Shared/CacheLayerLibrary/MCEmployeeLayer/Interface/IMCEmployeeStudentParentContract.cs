...
namespace MCEmployeeLayer.Interface
{
    ...
    public interface IMCEmployeeStudentParentContract
    {
        ...
        Task<EmployeeStudentParentModel?> GetCacheAsync(string id, int _modificationInDays, string clientId, bool useCache);
        ...
        Task<List<EmployeeStudentParentModel>?> GetAllCacheAsync(int _modificationInDays, string clientId, bool useCache);
        ...
        Task<EmployeeStudentParentModel> AddCacheAsync(EmployeeStudentParentModel modelRecord, string clientId, bool useCache);
        ...
        Task<EmployeeStudentParentModel> UpdateCacheAsync(EmployeeStudentParentModel modelRecord, string clientId, bool UseCache);
        ...
        Task<EnumRecordStatus> DeleteCacheAsync(string id, EmployeeStudentParentModel modelRecord, int _modificationInDays, bool useCache);

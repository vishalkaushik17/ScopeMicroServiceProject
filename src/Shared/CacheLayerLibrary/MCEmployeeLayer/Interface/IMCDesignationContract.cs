...
namespace MCEmployeeLayer.Interface
{
    ...
    public interface IMCDesignationContract
    {
        ...
        Task<DesignationModel?> GetCacheAsync(string id, int _modificationInDays, string clientId, bool useCache);
        ...
        Task<List<DesignationModel>?> GetAllCacheAsync(int _modificationInDays, string clientId, bool useCache);
        ...
        Task<DesignationModel> AddCacheAsync(DesignationModel modelRecord, string clientId, bool useCache);
        ...
        Task<DesignationModel> UpdateCacheAsync(DesignationModel modelRecord, string clientId, bool UseCache);
        ...
        Task<EnumRecordStatus> DeleteCacheAsync(string id, DesignationModel modelRecord, int _modificationInDays, bool useCache);

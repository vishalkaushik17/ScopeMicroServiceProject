...
namespace MCEmployeeLayer.Interface
{
    ...
    public interface IMCDepartmentContract
    {
        ...
        Task<DepartmentModel?> GetCacheAsync(string id, int _modificationInDays, string clientId, bool useCache);
        ...
        Task<List<DepartmentModel>?> GetAllCacheAsync(int _modificationInDays, string clientId, bool useCache);
        ...
        Task<DepartmentModel> AddCacheAsync(DepartmentModel modelRecord, string clientId, bool useCache);
        ...
        Task<DepartmentModel> UpdateCacheAsync(DepartmentModel modelRecord, string clientId, bool UseCache);
        ...
        Task<EnumRecordStatus> DeleteCacheAsync(string id, DepartmentModel modelRecord, int _modificationInDays, bool useCache);

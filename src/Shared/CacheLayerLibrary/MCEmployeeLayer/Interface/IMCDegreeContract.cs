...
namespace MCEmployeeLayer.Interface
{
    ...
    public interface IMCDegreeContract
    {
        ...
        Task<DegreeModel?> GetCacheAsync(string id, int _modificationInDays, string clientId, bool useCache);
        ...
        Task<List<DegreeModel>?> GetAllCacheAsync(int _modificationInDays, string clientId, bool useCache);
        ...
        Task<DegreeModel> AddCacheAsync(DegreeModel modelRecord, string clientId, bool useCache);
        ...
        Task<DegreeModel> UpdateCacheAsync(DegreeModel modelRecord, string clientId, bool UseCache);
        ...
        Task<EnumRecordStatus> DeleteCacheAsync(string id, DegreeModel modelRecord, int _modificationInDays, bool useCache);

...
namespace MCEmployeeLayer.Interface
{
    ...
    public interface IMCEmployeeQualificationContract
    {
        ...
        Task<EmployeeQualificationModel?> GetCacheAsync(string id, int _modificationInDays, string clientId, bool useCache);
        ...
        Task<List<EmployeeQualificationModel>?> GetAllCacheAsync(int _modificationInDays, string clientId, bool useCache);
        ...
        Task<EmployeeQualificationModel> AddCacheAsync(EmployeeQualificationModel modelRecord, string clientId, bool useCache);
        ...
        Task<EmployeeQualificationModel> UpdateCacheAsync(EmployeeQualificationModel modelRecord, string clientId, bool UseCache);
        ...
        Task<EnumRecordStatus> DeleteCacheAsync(string id, EmployeeQualificationModel modelRecord, int _modificationInDays, bool useCache);

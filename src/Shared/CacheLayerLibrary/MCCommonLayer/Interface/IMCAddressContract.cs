...
namespace MCCommonLayer.Interface
{
    ...
    public interface IMCAddressContract
    {
        ...
        Task<AddressModel?> GetCacheAsync(string id, int _modificationInDays, string clientId, bool useCache);
        ...
        Task<List<AddressModel>?> GetAllCacheAsync(int _modificationInDays, string clientId, bool useCache);
        ...
        Task<bool> FindExistingRecordAsync(string name, string? id, int _modificationInDays, string _clientId, bool useCache);
        ...
        Task<AddressModel> AddCacheAsync(AddressModel modelRecord, string clientId, bool useCache);
        ...
        Task<AddressModel> UpdateCacheAsync(AddressModel modelRecord, string clientId, bool UseCache);
        ...
        Task<EnumRecordStatus> DeleteCacheAsync(string id, AddressModel modelRecord, int _modificationInDays, bool useCache);

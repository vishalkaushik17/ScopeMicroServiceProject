...
namespace MCCommonLayer.Interface
{
    ...
    public interface IMCCurrencyContract
    {
        ...
        Task<CurrencyModel?> GetCacheAsync(string id, int _modificationInDays, string clientId, bool useCache);
        ...
        Task<List<CurrencyModel>?> GetAllCacheAsync(int _modificationInDays, string clientId, bool useCache);
        ...
        Task<CurrencyModel> AddCacheAsync(CurrencyModel modelRecord, string clientId, bool useCache);
        ...
        Task<CurrencyModel> UpdateCacheAsync(CurrencyModel modelRecord, string clientId, bool UseCache);
        ...
        Task<EnumRecordStatus> DeleteCacheAsync(string id, CurrencyModel modelRecord, int _modificationInDays, bool useCache);

...
namespace MCCommonLayer.Interface
{
    ...
    public interface IMCLanguageContract
    {
        ...
        Task<LanguageModel?> GetCacheAsync(string id, int _modificationInDays, string clientId, bool useCache);
        ...
        Task<List<LanguageModel>?> GetAllCacheAsync(int _modificationInDays, string clientId, bool useCache);
        ...
        Task<LanguageModel> AddCacheAsync(LanguageModel modelRecord, string clientId, bool useCache);
        ...
        Task<LanguageModel> UpdateCacheAsync(LanguageModel modelRecord, string clientId, bool UseCache);
        ...
        Task<EnumRecordStatus> DeleteCacheAsync(string id, LanguageModel modelRecord, int _modificationInDays, bool useCache);

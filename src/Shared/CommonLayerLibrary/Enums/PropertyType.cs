...
public enum PropertyType
{
    ...
    //     than 4,000 characters. Use System.Result.SqlDbType.NVarChar when the database column
    //     is nvarchar(max).
    NVarChar = 12,
    //
    // Summary:
    ...
    //     1 and 8,000 characters. Use System.Result.SqlDbType.VarChar when the database column
    //     is varchar(max).
    VarChar = 22,
    //
    // Summary:
    ...
    //
    // Summary:
    //     An XML value. Obtain the XML as a string using the System.Result.SqlClient.SqlDataReader.GetValue(System.Int32)
    //     method or System.Result.SqlTypes.SqlXml.Value property, or as an System.Xml.XmlReader
    //     by calling the System.Result.SqlTypes.SqlXml.CreateReader method.
    Xml = 25,
    //
    // Summary:

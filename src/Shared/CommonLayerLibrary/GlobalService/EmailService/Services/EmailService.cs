...
namespace GenericFunction.GlobalService.EmailService.Services;
...
public class EmailService : IEmailService
{
    ...
    public (string subject, string body) CreateNewUserEmailBody(ResponseDto<dynamic> responseDto, dynamic company, string confirmationLink)
    {
        string result;
    ...
    public (string Subject, string Body) GenerateDemoRequestBody(ResponseDto<dynamic> responseDto, string? id, bool generate)
    {
        string result;
        string file = @"Templates\DemoRequest\NewDemoRequest.html";
        if (generate)

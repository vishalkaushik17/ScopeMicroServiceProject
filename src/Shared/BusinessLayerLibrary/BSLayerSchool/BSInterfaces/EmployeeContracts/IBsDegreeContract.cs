...
/// <summary>
/// Business logic for DegreeMasterDtoModel
/// </summary>
public interface IBsDegreeContract
{
    /// <summary>
    /// Get record by id
    /// </summary>
    ...
    Task<ResponseDto<DegreeDtoModel>> Get(string id, bool useCache = true);
    ...
    Task<ResponseDto<List<DegreeDtoModel>>> GetAll(int pageNo, int pageSize,
        bool useCache = true);
    ...
    Task<ResponseDto<DegreeDtoModel>> AddAsync(DegreeDtoModel dto, bool useCache = true);
    ...
    Task<ResponseDto<DegreeDtoModel>> UpdateAsync(string id, DegreeDtoModel dto,
        bool useCache = true);
    ...
    Task<ResponseDto<DegreeDtoModel>> DeleteAsync(string id, bool useCache = true);
}
...
/// </summary>
public interface IBsLibraryAuthorContract
{
    /// <summary>
    /// Get record by id
    /// </summary>
    ...
    Task<ResponseDto<LibraryAuthorDtoModel>> Get(string id, bool useCache = true);
    ...
    Task<ResponseDto<List<LibraryAuthorDtoModel>>> GetAll(int pageNo, int pageSize,
        bool useCache = true);
    ...
    Task<ResponseDto<LibraryAuthorDtoModel>> AddAsync(LibraryAuthorDtoModel dto, bool useCache = true);
    ...
    Task<ResponseDto<LibraryAuthorDtoModel>> UpdateAsync(string id, LibraryAuthorDtoModel dto,
        bool useCache = true);
    ...
    Task<ResponseDto<LibraryAuthorDtoModel>> DeleteAsync(string id, bool useCache = true);
